...
const BatteryCharging = createLucideIcon("battery-charging", __iconNode$z);
const __iconNode$y = [
  ["path", { d: "M 22 14 L 22 10", key: "nqc4tb" }],
  ["rect", { x: "2", y: "6", width: "16", height: "12", rx: "2", key: "13zb55" }]
];
const Battery = createLucideIcon("battery", __iconNode$y);
const __iconNode$x = [
...
const CarFront = createLucideIcon("car-front", __iconNode$t);
