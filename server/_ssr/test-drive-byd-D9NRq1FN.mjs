...
import { u as useI18n, P as PageShell } from "./router-D3a4YMuA.mjs";
...
const BENEFITS = [{
  icon: CarFront,
  titleKey: "testDrive.benefitModelsTitle",
  descKey: "testDrive.benefitModelsDesc"
}, {
  icon: Coffee,
  titleKey: "testDrive.benefitHospitalityTitle",
  descKey: "testDrive.benefitHospitalityDesc"
}, {
  icon: Clock,
  titleKey: "testDrive.benefitTimeTitle",
  descKey: "testDrive.benefitTimeDesc"
}, {
  icon: MapPin,
  titleKey: "testDrive.benefitLocationTitle",
  descKey: "testDrive.benefitLocationDesc"
}];
const FAQS = [{
  qKey: "testDrive.faq1q",
  aKey: "testDrive.faq1a"
}, {
  qKey: "testDrive.faq2q",
  aKey: "testDrive.faq2a"
}, {
  qKey: "testDrive.faq3q",
  aKey: "testDrive.faq3a"
}];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: heroImg, alt: t("testDrive.heroAlt"), width: 1920, height: 1080, className: "h-full w-full object-cover" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-normal animate-fade-in-up", children: t("testDrive.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-lg text-muted-foreground max-w-xl animate-fade-in-up", children: t("testDrive.subtitle") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex flex-wrap gap-3 animate-fade-in-up", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#why", className: "inline-flex items-center gap-2 rounded-full glass px-6 py-3 text-sm font-semibold hover:bg-background/40 transition", children: t("testDrive.viewBenefits") })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "why", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold", children: t("testDrive.whyTitle") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-muted-foreground", children: t("testDrive.whySubtitle") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 grid sm:grid-cols-2 gap-4", children: BENEFITS.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-xl p-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 font-bold", children: t(b.titleKey) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground mt-1", children: t(b.descKey) })
        ] }, b.titleKey)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "booking", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TestDriveForm, {}) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FAQ, { items: faqItems })
  ] });
}
export {
