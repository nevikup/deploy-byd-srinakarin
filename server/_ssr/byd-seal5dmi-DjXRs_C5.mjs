...
import { d as SLUG$6, u as useI18n, P as PageShell } from "./router-DAtOa4Us.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { g as getInstallmentModel, c as calcInstallment, f as formatBaht, h as colorWhite } from "./models-2MA_lXr_.mjs";
...
import { A as ArrowRight, l as Play, R as Ruler, G as Gauge, j as Battery, m as Weight, S as ShieldCheck, n as CircuitBoard, a as Check, k as Minus } from "../_libs/lucide-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full px-6 sm:px-12 lg:px-20 pb-16 pt-32", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-block rounded-full border border-primary/40 px-3 py-1 text-xs text-primary mb-4 backdrop-blur-sm bg-background/20", children: [
            isEn ? "Plug-in Hybrid Sedan" : "รถซีดานปลั๊กอินไฮบริด",
            " · DM-i Super PHEV"
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 180, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          { label: isEn ? "System Power" : "กำลังรวม", val: "160 kW" },
          { label: isEn ? "Motor Power" : "กำลังมอเตอร์", val: "145 kW" },
          { label: isEn ? "Motor Torque" : "แรงบิดมอเตอร์", val: "300 Nm" },
          { label: isEn ? "0-100 km/h" : "0-100 กม./ชม.", val: isEn ? "7.5 sec" : "7.5 วินาที" },
          { label: isEn ? "Premium EV Range" : "ระยะทางไฟฟ้า Premium", val: "120 km" }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 border-y border-border bg-surface/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 140, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "glass rounded-3xl p-6 sm:p-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: isEn ? "Price" : "ราคา", value: formatBaht(currentTrim.price) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: isEn ? "0-100 km/h" : "0-100 กม./ชม.", value: `${currentTrim.accel} ${isEn ? "sec" : "วินาที"}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: isEn ? "EV Range" : "ระยะทางไฟฟ้า", value: `${currentTrim.evRange} km` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: isEn ? "Battery" : "แบตเตอรี่", value: currentTrim.battery }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Tile, { label: isEn ? "Motor" : "มอเตอร์", value: currentTrim.motor })
      ] }) }) })
    ] }) }),
      ...
      !videoPlaying && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-white text-lg font-semibold tracking-widest uppercase", children: isEn ? "BYD SEAL 5 DM-i — Official Film" : "BYD SEAL 5 DM-i — วิดีโออย่างเป็นทางการ" })
          ]
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-surface/40 border-y border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: isEn ? "Design" : "ดีไซน์" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: isEn ? "* Harbour Grey is exclusive to the Premium grade" : "* สี Harbour Grey มีเฉพาะรุ่น Premium" })
      ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-y border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FeatureBlock,
        {
          ...
          subtitle: isEn ? "Ocean Aesthetic" : "งานดีไซน์แรงบันดาลจากท้องทะเล",
          body: isEn ? "A premium sporty design inspired by the ocean, expressing both strength and fluidity in every line" : "ดีไซน์สปอร์ตระดับพรีเมียมที่ได้แรงบันดาลจากท้องทะเล ถ่ายทอดทั้งความแข็งแกร่งและความลื่นไหลในทุกเส้นสาย",
          reverse: false,
          imageFullWidth: true
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FeatureBlock,
        {
          ...
          subtitle: isEn ? "Hybrid Innovation" : "นวัตกรรมไฮบริด",
          body: isEn ? "DM-i Super PHEV technology combines a high-output electric motor with a 1.5L engine for performance and everyday efficiency" : "เทคโนโลยี DM-i Super PHEV ผสานมอเตอร์ไฟฟ้ากำลังสูงเข้ากับเครื่องยนต์ 1.5L เพื่อสมรรถนะและความประหยัดในการใช้งานทุกวัน",
          reverse: true
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FeatureBlock,
        {
          ...
          subtitle: isEn ? "Core Technology" : "เทคโนโลยีหลัก",
          body: isEn ? "Powered by BYD Blade Battery safety and an intelligent plug-in hybrid system that responds instantly" : "ขับเคลื่อนด้วยความปลอดภัยของ BYD Blade Battery และระบบปลั๊กอินไฮบริดอัจฉริยะที่ตอบสนองฉับไว",
          reverse: false
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: isEn ? "Tech Spec" : "ข้อมูลทางเทคนิค" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: isEn ? "Technical Specifications" : "สเปคทางเทคนิค" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleSpec, { title: isEn ? "Dimensions and Size" : "มิติและขนาดตัวรถ", icon: Ruler, rows: isEn ? DIMENSIONS_EN : DIMENSIONS }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CompareSpec, { title: isEn ? "Drivetrain and Performance" : "ระบบขับเคลื่อนและสมรรถนะ", icon: Gauge, rows: isEn ? POWERTRAIN_EN : POWERTRAIN, isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CompareSpec, { title: isEn ? "Energy and Battery" : "พลังงานและแบตเตอรี่", icon: Battery, rows: isEn ? ENERGY_EN : ENERGY, isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleSpec, { title: isEn ? "Suspension, Brakes and Wheels" : "ช่วงล่าง เบรก และล้อ", icon: Weight, rows: isEn ? CHASSIS_EN : CHASSIS }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CompareSpec, { title: isEn ? "Safety Systems" : "ระบบความปลอดภัย", icon: ShieldCheck, rows: isEn ? SAFETY_EN : SAFETY, isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CompareSpec, { title: isEn ? "Multimedia and Comfort" : "มัลติมีเดียและความสะดวกสบาย", icon: CircuitBoard, rows: isEn ? MULTIMEDIA_EN : MULTIMEDIA, isEn }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "installment", className: "py-20 bg-surface/40 border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: isEn ? "BYD SEAL 5 DM-i Payment Plan" : "แผนผ่อน BYD SEAL 5 DM-i" }) }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "test-drive", className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: isEn ? "Test Drive BYD SEAL 5 DM-i" : "นัดทดลองขับ BYD SEAL 5 DM-i" }) }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FAQ, { items: faqs, title: isEn ? "Frequently Asked Questions About BYD SEAL 5 DM-i" : "คำถามที่พบบ่อยเกี่ยวกับ BYD SEAL 5 DM-i" })
  ] });
}
...
function FeatureBlock({ img, title, subtitle, body, reverse, imageFullWidth = false }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex flex-col ${imageFullWidth ? "" : reverse ? "lg:flex-row-reverse" : "lg:flex-row"} items-stretch`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { className: imageFullWidth ? "w-full" : "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: img,
        alt: title,
        className: imageFullWidth ? "block w-full h-auto object-contain" : "w-full object-cover",
        style: imageFullWidth ? void 0 : { height: "clamp(260px, 40vw, 520px)" }
      }
    ) }),
...
function CompareSpec({ title, icon: Icon, rows, isEn }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-6 py-4 border-b border-border bg-background/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-5 w-5 text-primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold", children: title })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "text-xs uppercase tracking-wider text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/60", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left font-medium px-6 py-3 normal-case", children: isEn ? "Item" : "รายการ" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: i % 2 === 0 ? "bg-background/20" : "", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { value: row.standard, isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { value: row.dynamic, isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { value: row.premium, isEn }) })
      ] }, row.label)) })
    ] }) })
  ] });
}
function Cell({ value, isEn }) {
  if (value === true) return /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "h-5 w-5 text-primary mx-auto", "aria-label": isEn ? "Included" : "มีให้" });
  if (value === false) return /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "h-4 w-4 text-muted-foreground mx-auto", "aria-label": isEn ? "Not included" : "ไม่มีให้" });
