...
import { s as Route$5, u as useI18n, A as ARTICLES, P as PageShell, t as heroImg, H as HOME_SLIDES_ENDPOINT, v as extractSlideImageUrls, w as extractLargestSrcsetUrl, x as normalizeImageUrl } from "./router-C51hCqcA.mjs";
...
const ModelsScroller = reactExports.lazy(() => import("./ModelsScroller-DJUQc4vM.mjs").then((module) => ({
...
const FAQ = reactExports.lazy(() => import("./FAQ-CII3UwB1.mjs").then((module) => ({
  default: module.FAQ
})));
