...
import { u as useI18n, P as PageShell, c as createSsrRpc } from "./router-CO0EzZXd.mjs";
...
const ContactBranchMap = reactExports.lazy(() => import("./ContactBranchMap-ffqffGpe.mjs"));
