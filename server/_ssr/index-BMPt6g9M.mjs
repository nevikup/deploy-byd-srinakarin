...
import { s as Route$5, u as useI18n, A as ARTICLES, P as PageShell, t as heroImg, H as HOME_SLIDES_ENDPOINT, v as extractSlideImageUrls, w as extractLargestSrcsetUrl, x as normalizeImageUrl } from "./router-CRL2Dm0N.mjs";
...
const ModelsScroller = reactExports.lazy(() => import("./ModelsScroller-E2r5u1Rm.mjs").then((module) => ({
...
const FAQ = reactExports.lazy(() => import("./FAQ-CYK0t0PE.mjs").then((module) => ({
  default: module.FAQ
})));
