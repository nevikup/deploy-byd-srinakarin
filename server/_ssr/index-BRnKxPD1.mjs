...
import { s as Route$4, A as ARTICLES, P as PageShell, t as heroImg, H as HOME_SLIDES_ENDPOINT, v as extractSlideImageUrls, w as extractLargestSrcsetUrl, x as normalizeImageUrl } from "./router-_Dkbm58u.mjs";
import { L as Link } from "../_libs/tanstack__react-router.mjs";
import { u as useIsMobile } from "./use-mobile-BsFue-bT.mjs";
import "../_libs/seroval.mjs";
import { A as ArrowRight, e as MapPin, x as Wallet, s as Gift, y as Calendar, X, w as ArrowLeft } from "../_libs/lucide-react.mjs";
...
const ModelsScroller = reactExports.lazy(() => import("./ModelsScroller-iVDLTUUu.mjs").then((module) => ({
...
const FAQ = reactExports.lazy(() => import("./FAQ-D-JUNdeh.mjs").then((module) => ({
  default: module.FAQ
})));
...
const FAQS = [{
  ...
  a: "BYD จินหลง มอเตอร์ ศรีนครินทร์ เป็นตัวแทนจำหน่ายอย่างเป็นทางการ ให้บริการครบวงจรทั้งการขาย ทดลองขับ บริการหลังการขาย พร้อมโปรโมชั่นพิเศษเฉพาะลูกค้าของเรา"
}];
const SEO_HUB = [{
  title: "BYD จินหลง มอเตอร์ ศรีนครินทร์",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-x-clip", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-screen overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto flex min-h-screen w-full max-w-7xl items-center px-4 py-32 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-2xl text-lg text-white sm:text-xl", children: "โชว์รูมและศูนย์บริการมาตรฐาน BYD สาขา ศรีนครินทร์" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-9 flex flex-wrap gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/test-drive-byd", hash: "booking", className: "inline-flex items-center gap-2 rounded-full glass border border-primary/40 px-7 py-3.5 text-base font-semibold hover:bg-primary/10 transition", children: "นัดทดลองขับ" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-7xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHead, { eyebrow: "รถยนต์ทุกรุ่น", eyebrowClassName: "bg-primary/10 text-primary", title: "รถทุกรุ่น", subtitle: "เลือกรุ่นที่ใช่สำหรับคุณ ทั้ง Sedan, SUV และ DM-i หลากหลายสไตล์" }) }),
