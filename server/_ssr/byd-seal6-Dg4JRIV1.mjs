...
import { b as SLUG$7, u as useI18n, P as PageShell } from "./router-D3a4YMuA.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, e as colorHorizonWhite } from "./models-hBzcyjxT.mjs";
...
import { A as ArrowRight, l as Play, G as Gauge, Z as Zap, j as Battery, S as ShieldCheck, a as Check, k as Minus } from "../_libs/lucide-react.mjs";
...
const EXTERIOR_GALLERY_EN = [
  {
    img: exteriorLed,
    label: "Full-width LED headlight",
    desc: "A full-width LED lighting signature with a distinctive front presence"
  },
  {
    img: exteriorDigitalKey,
    label: "BYD Digital Key",
    desc: "Supports digital key and NFC Card for convenient everyday use"
  },
  {
    img: exteriorFrontTrunk,
    label: "Front trunk (frunk)",
    desc: "65-liter front storage space that adds everyday practicality"
  },
  {
    img: exteriorVtoL,
    label: "V2L function",
    desc: "Delivers flexible power from the vehicle to external devices"
  },
  {
    img: exteriorAlloyWheel,
    label: "18-inch alloy wheel",
    desc: "Sporty alloy wheels with a balance of style and performance"
  }
];
...
const INTERIOR_GALLERY_EN = [
  {
    img: interiorInstrumentDisplay,
    label: "8.8-inch instrument display",
    desc: "A digital cluster that presents driving information clearly"
  },
  {
    img: interiorMultimediaTouchScreen,
    label: "12.8-inch multimedia touchscreen",
    desc: "A large touchscreen with full multimedia functionality"
  },
  {
    img: interiorWirelessCharger,
    label: "Wireless charger",
    desc: "Wireless smartphone charging for added convenience on the move"
  },
  {
    img: interiorVentilatedFrontSeats,
    label: "Ventilated front seats",
    desc: "Front seats with ventilation to keep every drive comfortable"
  },
  {
    img: storyInfotainmentImage,
    label: "Connected infotainment",
    desc: "A digital cabin experience with smart connectivity features"
  }
];
...
const dimensionsRowsEn = [
  { label: "Length (mm)", dynamic: "4,720", premium: "4,720" },
  { label: "Width (mm)", dynamic: "1,860", premium: "1,860" },
  { label: "Height (mm)", dynamic: "1,495", premium: "1,495" },
  { label: "Wheelbase (mm)", dynamic: "2,820", premium: "2,820" },
  { label: "Front trunk capacity (L)", dynamic: "65", premium: "65" },
  { label: "Rear trunk capacity (L)", dynamic: "460", premium: "460" },
  { label: "Curb weight (kg)", dynamic: "1,780", premium: "1,800" }
];
...
const powertrainRowsEn = [
  { label: "Drive system", dynamic: "Rear-wheel drive", premium: "Rear-wheel drive" },
  {
    label: "Motor type",
    dynamic: "Permanent magnet synchronous motor",
    premium: "Permanent magnet synchronous motor"
  },
  { label: "Max motor power (kW)", dynamic: "95", premium: "160" },
  { label: "Max motor torque (Nm)", dynamic: "220", premium: "330" },
  { label: "0-100 km/h (seconds)", dynamic: "10.9", premium: "7.5" }
];
const chargingRows = [
...
const chargingRowsEn = [
  { label: "Battery type", dynamic: "BYD Blade Battery", premium: "BYD Blade Battery" },
  { label: "Max battery capacity (kWh)", dynamic: "56.64", premium: "56.64" },
  { label: "Maximum driving range (NEDC, km)", dynamic: "485", premium: "485" },
  { label: "AC Type 2 charging support (max kW)", dynamic: "7", premium: "7" },
  { label: "DC CCS2 charging support (max kW)", dynamic: "100", premium: "100" },
  { label: "V2L (Vehicle-to-Load)", dynamic: "●", premium: "●" },
  { label: "Regenerative braking", dynamic: "●", premium: "●" }
];
const safetyRows = [
...
const safetyRowsEn = [
  { label: "Front airbags", dynamic: "●", premium: "●" },
  { label: "Side airbags", dynamic: "●", premium: "●" },
  { label: "Side curtain airbags", dynamic: "●", premium: "●" },
  { label: "360-degree surround view camera", dynamic: "●", premium: "●" },
  { label: "ACC", dynamic: "●", premium: "●" },
  { label: "AEB", dynamic: "●", premium: "●" },
  { label: "LDW / LDP", dynamic: "●", premium: "●" },
  { label: "IHBC", dynamic: "●", premium: "●" }
...
const storySectionsEn = [
  {
    ...
    title: "BLADE BATTERY",
    subtitle: "Safety Technology",
    body: "Battery technology designed to elevate safety, durability, and confidence for everyday use."
  },
  {
    image: storyEPlatformImage,
    title: "e-Platform 3.0 + CTB",
    subtitle: "EV Architecture",
    body: "An EV platform that combines Cell-to-Body structure for strength, balance, and confidence on every journey."
  },
  {
    image: storyInfotainmentImage,
    title: "Connected Lifestyle",
    subtitle: "Infotainment",
    body: "A multimedia system and smart features that keep every trip connected and easy to use."
  }
];
...
function BydSeal6Brochure({ model }) {
  ...
  const storyContent = isEn ? storySectionsEn : storySections;
  const dimensionRows = isEn ? dimensionsRowsEn : dimensionsRows;
  const powertrainContent = isEn ? powertrainRowsEn : powertrainRows;
  const chargingContent = isEn ? chargingRowsEn : chargingRows;
  const safetyContent = isEn ? safetyRowsEn : safetyRows;
  ...
  const faqs = [
    {
      q: isEn ? "How much is the BYD SEAL 6?" : "BYD SEAL 6 ราคาเท่าไร?",
      a: isEn ? "Dynamic starts at ฿799,900 and Premium at ฿949,900, with promotions available from time to time" : "Dynamic ราคา 799,900 บาท และ Premium ราคา 949,900 บาท พร้อมโปรโมชันตามช่วงเวลา"
    },
    {
      q: isEn ? "How far can the BYD SEAL 6 drive?" : "BYD SEAL 6 วิ่งได้ไกลกี่กิโลเมตร?",
      a: isEn ? "Up to 485 kilometers of range under the NEDC standard" : "ระยะทางวิ่งสูงสุด 485 กิโลเมตร ตามมาตรฐาน NEDC"
    },
    {
      q: isEn ? "What charging does the BYD SEAL 6 support?" : "BYD SEAL 6 รองรับการชาร์จแบบใด?",
      a: isEn ? "Supports AC Type 2 up to 7 kW and DC CCS2 up to 100 kW, with V2L support" : "รองรับ AC Type 2 สูงสุด 7 kW และ DC CCS2 สูงสุด 100 kW พร้อมระบบ V2L"
    },
    {
      q: isEn ? "What is the monthly payment for the BYD SEAL 6?" : "ผ่อน BYD SEAL 6 เดือนละเท่าไร?",
      a: isEn ? `Monthly payments start from ${formatBaht(installment.monthly)}/month (20% down, 60 installments, 2.49% interest)` : `ค่างวดเริ่มต้น ${formatBaht(installment.monthly)}/เดือน (ดาวน์ 20% ผ่อน 60 งวด ดอกเบี้ย 2.49%)`
    }
  ];
  const vehicleSchema = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative flex min-h-[88vh] w-full items-end overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full px-6 pb-16 pt-32 sm:px-12 lg:px-20", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 inline-block rounded-full border border-primary/40 bg-background/20 px-3 py-1 text-xs text-primary backdrop-blur-sm", children: isEn ? "Electric Sedan · e-Platform 3.0 · 2026" : "Electric Sedan · e-Platform 3.0 · 2026" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-xl font-light tracking-widest text-muted-foreground sm:text-2xl", children: isEn ? "UPGRADE YOUR EVERY DRIVE" : "UPGRADE YOUR EVERY DRIVE" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          { label: isEn ? "Max Range" : "Max Range", val: `${currentTrim.range} km` },
          { label: isEn ? "0-100 km/h" : "0-100 km/h", val: `${currentTrim.accel} sec` },
          { label: isEn ? "Max Power" : "Max Power", val: currentTrim.power },
          { label: isEn ? "Battery" : "Battery", val: currentTrim.battery },
          { label: isEn ? "Fast Charge" : "Fast Charge", val: currentTrim.charge }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-y border-border bg-surface/40 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 text-sm font-semibold text-primary", children: isEn ? "Variants" : "Variants" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "overflow-hidden border-y border-border bg-surface/40 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold sm:text-4xl", children: isEn ? "Choose the color that suits you" : "เลือกสีที่ใช่สำหรับคุณ" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs text-muted-foreground", children: isEn ? "* Ash Green is available on the Premium trim only" : "* สี Ash Green มีเฉพาะรุ่น Premium" })
      ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold sm:text-4xl", children: isEn ? "Distinctive in every detail" : "ตอบโจทย์โดดเด่นไม่เหมือนใคร" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "overflow-hidden border-y border-border", children: storyContent.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      FeatureBlock,
      {
        img: item.image,
        imgAlt: item.title,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 text-sm font-semibold text-primary", children: isEn ? "Tech Spec" : "Tech Spec" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: isEn ? "Dimensions & Weight" : "ขนาดและน้ำหนัก", icon: Gauge, rows: toSpecRows(dimensionRows), isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: isEn ? "Powertrain" : "ระบบส่งกำลังและสมรรถนะ", icon: Zap, rows: toSpecRows(powertrainContent), isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: isEn ? "Charging" : "พลังงานใหม่", icon: Battery, rows: toSpecRows(chargingContent), isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable, { title: isEn ? "Safety" : "ระบบความปลอดภัย", icon: ShieldCheck, rows: toSpecRows(safetyContent), isEn }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "installment", className: "border-y border-border bg-surface/40 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 text-sm font-semibold text-primary", children: isEn ? "Finance" : "Finance" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold sm:text-4xl", children: isEn ? "BYD SEAL 6 installment plan" : "ตารางผ่อน BYD SEAL 6" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "test-drive", className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 text-sm font-semibold text-primary", children: isEn ? "Test Drive" : "Test Drive" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold sm:text-4xl", children: isEn ? "Book a BYD SEAL 6 test drive" : "นัดทดลองขับ BYD SEAL 6" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FAQ, { items: faqs, title: isEn ? "Frequently asked questions about BYD SEAL 6" : "คำถามที่พบบ่อยเกี่ยวกับ BYD SEAL 6" }),
...
function Cell({ value, isEn }) {
  if (value === true) return /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "mx-auto h-5 w-5 text-primary", "aria-label": isEn ? "Yes" : "มี" });
  if (value === false) return /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "mx-auto h-4 w-4 text-muted-foreground", "aria-label": isEn ? "No" : "ไม่มี" });
