...
import { p as SLUG, u as useI18n, P as PageShell } from "./router-DAtOa4Us.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, o as colorShellWhite } from "./models-2MA_lXr_.mjs";
...
import { A as ArrowRight, l as Play, U as Users, G as Gauge, j as Battery, Z as Zap, p as Sparkles, n as CircuitBoard, S as ShieldCheck, a as Check, k as Minus } from "../_libs/lucide-react.mjs";
...
const EXTERIOR_GALLERY_EN = [
  { img: exteriorBodyDesign, label: "Sport Body Design", desc: "Sharp body lines with a modern city-car stance" },
  { img: exteriorHeadLight, label: "LED Headlights", desc: "Distinct LED headlights with a 3D crystal-like surface" },
  { img: exteriorAllowWheel, label: "16-inch Alloy Wheels", desc: "16-inch alloy wheels focused on agility and control" },
  { img: exteriorDigitalKey, label: "BYD Digital Key", desc: "Lock, unlock, and start the car with your smartphone" },
  { img: exteriorCharging, label: "Charging Port", desc: "A charging port designed for safe, convenient use" },
  { img: exteriorSpoiler, label: "Rear Spoiler", desc: "A sporty rear spoiler that sharpens the silhouette" }
];
...
const INTERIOR_GALLERY_EN = [
  { img: interiorConsoleDesign, label: "Wave Shape Console", desc: "A modern front console designed for easy everyday use" },
  { img: interiorMultimediaScreen, label: "10.1-inch Multimedia", desc: "10.1-inch touchscreen with a complete entertainment suite" },
  { img: interiorWirelessCharger, label: "Wireless Charging", desc: "Wireless charging for a modern digital lifestyle" },
  { img: interiorRearPassengerSpace, label: "Spacious Cabin", desc: "A roomy rear cabin that keeps every trip comfortable" },
  { img: interiorDriverSeat, label: "Driver Seat", desc: "A driver's seat designed for comfort on every trip" },
  { img: interiorEasyControl, label: "Easy Control Switches", desc: "Easy-to-reach switches for convenient control" },
  { img: interiorLuggageCapacity, label: "Luggage Capacity", desc: "Spacious luggage room for everyday needs" },
  { img: interiorSteeringAdjustment, label: "Steering Adjustment", desc: "An adjustable steering wheel for a comfortable driving position" }
];
const DIMENSIONS = [
...
const DIMENSIONS_EN = [
  { label: "Length (mm)", values: ["3,925", "3,925"] },
  { label: "Width (mm)", values: ["1,720", "1,720"] },
  { label: "Height (mm)", values: ["1,590", "1,590"] },
  { label: "Front / rear track (mm)", values: ["1,500 /1,485", "1,500 /1,485"] },
  { label: "Wheelbase (mm)", values: ["2,500", "2,500"] },
  { label: "Loaded ground clearance (mm)", values: ["120", "120"] },
  { label: "Minimum turning radius (m)", values: ["4.95", "4.95"] },
  { label: "Cargo volume (L)", values: ["230", "230"] },
  { label: "Curb weight (kg)", values: ["1,225", "1,280"] },
  { label: "Gross vehicle weight (kg)", values: ["1,635", "1,690"] }
];
const PERFORMANCE = [
...
const PERFORMANCE_EN = [
  ...
  { label: "Front motor type", values: ["Permanent Magnet Synchronous Motor (PMS)", "Permanent Magnet Synchronous Motor (PMS)"] },
  { label: "Maximum power (kW)", values: ["55", "55"] },
  { label: "Maximum torque (Nm)", values: ["135", "135"] },
  { label: "0-50 km/h (seconds)", values: ["4.9", "4.9"] },
  { label: "Drive modes", values: ["ECO / Normal / Sport", "ECO / Normal / Sport"] }
];
const CHARGING = [
...
const CHARGING_EN = [
  ...
  { label: "Battery capacity (kWh)", values: ["30.08", "38.88"] },
  { label: "NEDC range (km)", values: ["300", "380"] },
  { label: "Portable charging cable (Mode 2)", values: [true, true] },
  { label: "AC Type 2 charger support, max (kW)", values: ["6.6", "6.6"] },
  { label: "DC CCS2 charger support, max (kW)", values: ["30", "40"] },
...
const SUSPENSION_BRAKE_EN = [
  { label: "Front suspension", values: ["MacPherson strut", "MacPherson strut"] },
  { label: "Rear suspension", values: ["Torsion beam", "Torsion beam"] },
...
const WHEELS_TIRES_EN = [
  { label: "Alloy wheels (in.)", values: ["16", "16"] },
  { label: "Tyre size", values: ["185/55 R16", "185/55 R16"] },
  { label: "Emergency tyre repair kit", values: [true, true] },
  { label: "Emergency vehicle repair tools", values: [true, true] }
];
const EXTERIOR_STD = [
...
const EXTERIOR_STD_EN = [
  { label: "LED headlights", values: [true, true] },
  { label: "Automatic headlight control", values: [true, true] },
  { label: "Manual headlight leveling", values: [true, true] },
  { label: "Follow-Me-Home headlight delay", values: [true, true] },
  { label: "LED daytime running lights", values: [true, true] },
  { label: "LED tail lights", values: [true, true] },
  { label: "Third brake light (LED)", values: [true, true] },
  { label: "Intermittent windshield wipers", values: [true, true] },
  { label: "Power-adjustable side mirrors", values: [true, true] },
  { label: "Rear window defogger", values: [true, true] },
  { label: "Shark fin antenna", values: [true, true] }
];
const INTERIOR_STD = [
...
const INTERIOR_STD_EN = [
  { label: "Multi-function steering wheel", values: [true, true] },
  { label: "Steering wheel adjustment", values: ["2-way", "4-way"] },
  { label: "Synthetic leather steering wheel", values: [true, true] },
  { label: "Instrument cluster display (in.)", values: ["7", "7"] },
  { label: "Seat upholstery", values: ["Synthetic leather", "Synthetic leather"] },
  { label: "One-touch auto up/down driver window with pinch protection", values: [false, true] },
  { label: "Front sun visor with mirror and light", values: [true, true] },
  { label: "6-way power driver seat", values: [false, true] },
  { label: "4-way manual driver seat", values: [true, false] },
  { label: "4-way manual front passenger seat", values: [true, true] },
  { label: "Foldable rear seatback", values: [true, true] },
...
const MULTIMEDIA_EN = [
  ...
  { label: "Air conditioning", values: [true, true] },
  { label: "PM2.5 air filter", values: [true, true] },
  { label: "Internet connectivity for BYD App and OTA updates", values: [true, true] },
  { label: "Software update support via internet (OTA)", values: [true, true] }
];
const SAFETY_EN = [
  { label: "Front airbags - driver and front passenger", values: [true, true] },
  { label: "Side airbags - driver and front passenger", values: [false, true] },
  { label: "Side curtain airbags, front and rear", values: [true, true] },
  { label: "Seat belt reminder, front and rear", values: [true, true] },
  { label: "Rear-view camera", values: [true, true] },
  { label: "Rear object detection sensors (3 points)", values: ["3", "3"] },
  ...
  { label: "Vehicle Dynamic Control (VDC)", values: [true, true] },
  { label: "Adaptive Cruise Control (ACC)", values: [false, true] },
  { label: "Intelligent Cruise Control (ICC)", values: [false, true] },
  { label: "Traffic Sign Recognition (TSR)", values: [false, true] },
  { label: "Intelligent Speed Limit Control (ISLC)", values: [false, true] },
  { label: "Autonomous Emergency Braking (AEB)", values: [false, true] },
  { label: "Forward Collision Warning (FCW)", values: [false, true] },
  { label: "Lane Departure Warning (LDW)", values: [false, true] },
  { label: "Lane Departure Prevention (LDP)", values: [false, true] },
  { label: "Intelligent High Beam Control (IHBC)", values: [false, true] },
  { label: "Tire Pressure Monitoring System (TPMS)", values: [true, true] }
];
const EXTERIOR_COLOR_EN = [
  { label: "Shell White", values: [true, true] },
  { label: "Quantum Black", values: [true, true] },
  { label: "Pop Green", values: [false, true] },
  { label: "Velocity Blue", values: [false, true] }
];
const INTERIOR_COLOR_EN = [
  { label: "Black + Gray", values: [true, true] }
];
const SAFETY = [
...
function BydAtto1Brochure({ model }) {
  ...
  const suspensionRows = isEn ? SUSPENSION_BRAKE_EN : SUSPENSION_BRAKE;
  const wheelsRows = isEn ? WHEELS_TIRES_EN : WHEELS_TIRES;
  const exteriorRows = isEn ? EXTERIOR_STD_EN : EXTERIOR_STD;
  const interiorRows = isEn ? INTERIOR_STD_EN : INTERIOR_STD;
  const multimediaRows = isEn ? MULTIMEDIA_EN : MULTIMEDIA;
  const safetyRows = isEn ? SAFETY_EN : SAFETY;
  const exteriorColorRows = isEn ? EXTERIOR_COLOR_EN : EXTERIOR_COLOR;
  const interiorColorRows = isEn ? INTERIOR_COLOR_EN : INTERIOR_COLOR;
  ...
  const faqs = isEn ? [
    { q: "How much is BYD ATTO 1?", a: "Dynamic starts at 429,900 THB · Premium starts at 459,900 THB, with the latest promotions from our team." },
    { q: "How far can it go?", a: "Dynamic up to 300 km and Premium up to 380 km based on NEDC." },
    { q: "What charging systems does it support?", a: "Supports AC Type 2 up to 6.6 kW, DC CCS2 up to 40 kW, and V2L." },
    { q: "What is the monthly payment?", a: `Estimated installment starts from ${formatBaht(r.monthly)}/month (20% down, 72 months, 2.79% interest).` }
  ] : [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative w-full min-h-[88vh] flex items-end overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full px-6 sm:px-12 lg:px-20 pb-16 pt-32", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block rounded-full border border-primary/40 px-3 py-1 text-xs text-primary mb-4 backdrop-blur-sm bg-background/20", children: isEn ? "Compact EV · Urban Mobility · 2026" : "Compact EV · Urban Mobility · 2026" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-xl sm:text-2xl text-muted-foreground font-light tracking-widest", children: isEn ? "MY URBAN MY EV" : "MY URBAN MY EV" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: isEn ? "Flexible design for every day" : "ดีไซน์ที่คล่องตัวพร้อมใช้งานทุกวัน" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-y border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: storyBatteryImage, imgAlt: "BYD Blade Battery", reverse: false, title: isEn ? "BYD BLADE BATTERY" : "BYD BLADE BATTERY", subtitle: isEn ? "Safety Technology" : "Safety Technology", body: isEn ? "High-safety battery technology that charges fast, drives far, and stays confident every day." : "เทคโนโลยีแบตเตอรี่ความปลอดภัยสูง ชาร์จไว ขับได้ไกล และมั่นใจได้ทุกวัน" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: storyImage1, imgAlt: "e-Platform", reverse: true, title: isEn ? "e-Platform 3.0" : "e-Platform 3.0", subtitle: isEn ? "EV Architecture" : "EV Architecture", body: isEn ? "An electric-car platform built for cabin space, safety, and strong driving efficiency." : "แพลตฟอร์มรถยนต์ไฟฟ้าที่ออกแบบเพื่อพื้นที่โดยสาร ความปลอดภัย และประสิทธิภาพการขับขี่" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: storyImage2, imgAlt: "High-strength body", reverse: false, title: isEn ? "HIGH-STRENGTH BODY" : "HIGH-STRENGTH BODY", subtitle: isEn ? "Structural Safety" : "Structural Safety", body: isEn ? "A high-strength body structure that boosts confidence on every route." : "โครงสร้างตัวถังแข็งแรงสูง ช่วยเพิ่มความมั่นใจในการเดินทางในทุกเส้นทาง" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Dimensions and weight" : "ขนาดและน้ำหนัก", icon: Users, rows: dimensionsRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Drivetrain and performance" : "ระบบส่งกำลังและสมรรถนะ", icon: Gauge, rows: performanceRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Battery and charging" : "แบตเตอรี่และการชาร์จ", icon: Battery, rows: chargingRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Suspension and brakes" : "ระบบกันสะเทือนและระบบเบรก", icon: Zap, rows: suspensionRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Wheels and tyres" : "ล้อและยาง", icon: Users, rows: wheelsRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Exterior standard equipment" : "อุปกรณ์มาตรฐานภายนอก", icon: Sparkles, rows: exteriorRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Interior standard equipment" : "อุปกรณ์มาตรฐานภายใน", icon: Users, rows: interiorRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Multimedia and convenience" : "ระบบมัลติมีเดียและความสะดวกสบาย", icon: CircuitBoard, rows: multimediaRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Safety" : "ระบบความปลอดภัย", icon: ShieldCheck, rows: safetyRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Exterior colors" : "สีภายนอก", icon: Sparkles, rows: exteriorColorRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Interior colors" : "สีภายใน", icon: Users, rows: interiorColorRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "installment", className: "py-20 bg-surface/40 border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: isEn ? "BYD ATTO 1 installment plan" : "ตารางผ่อน BYD ATTO 1" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "test-drive", className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: isEn ? "Book a BYD ATTO 1 test drive" : "นัดทดลองขับ BYD ATTO 1" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FAQ, { items: faqs, title: isEn ? "Frequently asked questions about BYD ATTO 1" : "คำถามที่พบบ่อยเกี่ยวกับ BYD ATTO 1" }),
