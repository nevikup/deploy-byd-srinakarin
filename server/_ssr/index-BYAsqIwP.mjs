...
import { s as Route$5, u as useI18n, A as ARTICLES, P as PageShell, t as heroImg, H as HOME_SLIDES_ENDPOINT, v as extractSlideImageUrls, w as extractLargestSrcsetUrl, x as normalizeImageUrl } from "./router-CXC-4l7h.mjs";
...
const ModelsScroller = reactExports.lazy(() => import("./ModelsScroller-DSIxv54F.mjs").then((module) => ({
...
const FAQ = reactExports.lazy(() => import("./FAQ-Clfyq6nE.mjs").then((module) => ({
  default: module.FAQ
})));
const POPUP_PAGE_ENDPOINT = "https://cms.jinlongmotors.co.th/wp-json/wp/v2/pages?slug=popup-nakornin";
const MODEL_HERO_VIDEOS = ["https://storage.googleapis.com/ram_asset_prd/models/atto1/atto1-video.webm", "https://storage.googleapis.com/ram_asset_prd/models/new-atto3/new-atto3-video.mp4", "https://www.reverautomotive.com//media/home/campaign-banners/Lifestyle-Home-VDO-Banner-desktop.mp4", "https://storage.googleapis.com/ram_asset_prd/models/seal5Dmi/seal5-video.mp4", "https://storage.googleapis.com/ram_asset_prd/models/seal6/overview/seal6-video.webm", "https://www.reverautomotive.com/videos/model/seal/seal-video.mp4", "https://storage.googleapis.com/ram_asset_prd/models/sealion5dmi/overview/sealion5dmi-video.webm", "https://storage.googleapis.com/ram_asset_prd/models/sealion7/overview/sealion7-video.webm"];
...
function HomePopupModal() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "popup-overlay-enter fixed inset-0 z-[80] flex items-center justify-center bg-black/65 px-3", role: "dialog", "aria-modal": "true", "aria-label": "Popup Promotion", onClick: () => setIsOpen(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "popup-card-enter w-auto max-h-[calc(100dvh-1rem)] max-w-[calc(100vw-1.5rem)] overflow-y-auto p-0", onClick: (event) => event.stopPropagation(), children: [
