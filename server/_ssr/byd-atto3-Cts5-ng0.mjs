...
import { n as SLUG$2, u as useI18n, P as PageShell, m as heroBanner$2 } from "./router-DAtOa4Us.mjs";
...
import { a as getModel, c as calcInstallment, f as formatBaht, l as colorWhite$4 } from "./models-2MA_lXr_.mjs";
...
const EXTERIOR_GALLERY_EN = [
  ...
  { img: extImg05, label: "Panoramic Glass Roof", desc: "A panoramic glass roof brings more light and openness to the cabin" },
  { img: extImg06, label: "Refined Exterior Details", desc: "Thoughtful exterior details complete the ATTO 3 design" }
];
...
const INTERIOR_GALLERY_EN = [
  ...
  { img: intImg05, label: "Premium Interior Comfort", desc: "A comfortable cabin with carefully designed details for every journey" },
  { img: intImg06, label: "Smart Cabin Technology", desc: "Intuitive technology and practical details enhance the driving experience" }
];
const DIMENSIONS = [
