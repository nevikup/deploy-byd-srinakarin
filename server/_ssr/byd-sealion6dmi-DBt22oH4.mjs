...
import { f as fallbackModel, u as useI18n, P as PageShell, h as heroBanner$3 } from "./router-CxN_7A6C.mjs";
...
import { g as getInstallmentModel, c as calcInstallment, f as formatBaht } from "./models-hBzcyjxT.mjs";
import "../_libs/seroval.mjs";
import { A as ArrowRight, l as Play, R as Ruler, Z as Zap, G as Gauge, j as Battery, m as Weight, S as ShieldCheck, n as Sparkles, a as Check, k as Minus } from "../_libs/lucide-react.mjs";
...
const DIMENSIONS_EN = [
  ...
  { label: "Length (mm)", values: ["4,775", "4,775"] },
  { label: "Width (mm)", values: ["1,890", "1,890"] },
  { label: "Height (mm)", values: ["1,670", "1,670"] },
  { label: "Front / rear track (mm)", values: ["1,630 / 1,630", "1,630 / 1,630"] },
  { label: "Wheelbase (mm)", values: ["2,765", "2,765"] },
  { label: "Minimum turning radius (m)", values: ["5.5", "5.5"] },
  { label: "Ground clearance (mm)", values: ["180", "180"] },
  { label: "Rear cargo capacity (L)", values: ["425", "425"] },
  { label: "Curb weight (kg)", values: ["1,850", "1,850"] },
  { label: "Gross vehicle weight (kg)", values: ["2,260", "2,260"] }
];
const DRIVETRAIN = [
...
const DRIVETRAIN_EN = [
  ...
  { label: "Max electric motor power (kW)", values: ["145", "145"] },
  { label: "Max electric motor torque (Nm)", values: ["300", "300"] },
  { label: "Engine type", values: ["Xiao Yun 1.5L PHEV", "Xiao Yun 1.5L PHEV"] },
  { label: "Max engine power (kW)", values: ["72", "72"] },
  { label: "Max engine torque (Nm)", values: ["122", "122"] },
  { label: "Total system power (kW)", values: ["160", "160"] },
  { label: "Total system torque (Nm)", values: ["300", "300"] },
  { label: "Fuel tank capacity (L)", values: ["45", "45"] }
];
const PERFORMANCE = [
...
const PERFORMANCE_EN = [
  { label: "Drive mode", values: ["HEV / EV", "HEV / EV"] },
  { label: "0-100 km/h (seconds)", values: ["8.5", "8.5"] },
...
const CHARGING_EN = [
  { label: "AC Type 2 support", values: ["up to 6.6 kW", "up to 6.6 kW"] },
...
const CHASSIS_EN = [
  { label: "Front / rear parking sensors", values: ["2 / 4", "2 / 4"] },
  { label: "Wheel type", values: ["Alloy", "Alloy"] },
  { label: "Wheel size", values: ["19 inches", "19 inches"] },
  { label: "360-degree surround view camera", values: [true, true] },
  { label: "NFC Card Key", values: [true, true] },
  { label: "Wireless charging pad", values: ["Dual", "Dual"] }
];
const MULTIMEDIA = [
...
const MULTIMEDIA_EN = [
  { label: "Touchscreen", values: ["12.8 inches", "15.6 inches"] },
  { label: "Speaker system", values: ["9 speakers", "9 speakers"] },
  { label: "Infinity audio", values: [false, true] },
  { label: "BYD Digital Key", values: [true, true] },
  { label: "Dual-zone climate control", values: [true, true] },
  { label: "PM2.5 filter", values: [true, true] }
];
const SAFETY = [
...
const SAFETY_EN = [
  ...
  { label: "Autonomous Emergency Braking", values: [false, true] },
  ...
  { label: "High Beam Assist (HMA)", values: [false, true] }
];
const EXTENDED_HIGHLIGHTS = [
  ...
  "หน้าจอกลาง 15.6 นิ้ว แบบ ไม่หมุน",
...
const EXTENDED_HIGHLIGHTS_EN = [
  "Battery capacity increased to 26.6 kWh",
  "NEDC EV range increased to 150 km",
  "DC fast charging increased to 55 kW",
  "Power side mirrors with memory function",
  "Auto-dimming rear-view mirror",
  "15.6-inch fixed (non-rotating) center display",
  "Head-up Display (W-HUD)",
  "8-way power-adjustable driver's seat",
  "Driver's seat ventilation",
  "Driver's seat memory function",
  "RGB Dynamic Mood ambient lighting",
  "DYNAUDIO 10-speaker sound system",
  "Metal welcome step side sills",
...
const STORY_SECTIONS_EN = [
  {
    ...
    body: "A specially developed 1.5-liter engine for plug-in hybrid use, working together with the motor and battery for efficiency and real-world performance."
  },
  {
  ...
  const faqs = [
    {
      ...
      a: isEn ? "Dynamic starts at ฿879,900 and Premium at ฿999,900, with the latest promotions from our advisors" : "Dynamic 879,900 บาท · Premium 999,900 บาท พร้อมโปรโมชันล่าสุดจากทีมที่ปรึกษา"
    },
    {
    ...
    },
    {
      ...
      a: isEn ? "Supports AC Type 2 up to 6.6 kW, DC CCS2 up to 18 kW, and V2L" : "รองรับ AC Type 2 สูงสุด 6.6 kW, DC CCS2 สูงสุด 18 kW และรองรับ V2L"
    },
    {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 border-y border-border bg-surface/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-3xl p-6 sm:p-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4", children: [
          { label: isEn ? "Drive System" : "Drive System", val: currentTrim.drive },
          { label: isEn ? "0-100 km/h" : "0-100 km/h", val: `${currentTrim.accel} sec` },
          { label: isEn ? "System Power" : "System Power", val: currentTrim.power },
          { label: isEn ? "Max Torque" : "Max Torque", val: currentTrim.torque },
          { label: isEn ? "Battery" : "Battery", val: currentTrim.battery },
          { label: isEn ? "Fuel Type" : "Fuel Type", val: "PHEV" }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          HighlightList,
          {
            title: isEn ? "BYD SEALION 6 DM-i Extended" : "BYD SEALION 6 DM-I รุ่น Extended",
            icon: Sparkles,
            items: isEn ? EXTENDED_HIGHLIGHTS_EN : EXTENDED_HIGHLIGHTS
          }
        ) })
      ] })
    ] }) }),
...
function HighlightList({ title, icon: Icon, items }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-2xl overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-6 py-4 border-b border-border bg-background/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-5 w-5 text-primary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-base font-bold", children: title })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 px-6 py-5", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-sm text-foreground/90", children: [
