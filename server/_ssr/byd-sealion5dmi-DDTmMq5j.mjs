...
import { a as SLUG$8, u as useI18n, P as PageShell } from "./router-CXC-4l7h.mjs";
...
import { a as getModel, c as calcInstallment, f as formatBaht, d as colorWhite$1 } from "./models-2MA_lXr_.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-y border-border py-16 sm:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-16 sm:space-y-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 max-w-3xl", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground leading-relaxed", children: isEn ? "BYD's exclusive battery innovation provides safety and durability through a special cell arrangement, giving you confidence on every journey and reliable performance for everyday life." : "นวัตกรรมใหม่ของเทคโนโลยีแบตเตอรี่ เอกสิทธิ์เฉพาะของ BYD ให้ความปลอดภัย และความทนทาน ด้วยการจัดวางเซลล์แบบพิเศษ มอบความมั่นใจในทุกการเดินทาง และรองรับการใช้งานในชีวิตประจำวันได้อย่างเต็มประสิทธิภาพ" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 max-w-3xl space-y-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground leading-relaxed", children: isEn ? "BYD DM-i technology delivers efficiency that takes you farther, with a total range of up to 1,200 km and up to 110 km of all-electric driving range (NEDC)." : "เทคโนโลยี BYD DM-i มอบความประหยัดที่ให้คุณไปได้ไกลกว่า โดยสามารถเดินทางได้ไกลถึง 1,200 กิโลเมตร และเดินทางด้วยไฟฟ้า 100% ได้ไกลสูงสุดถึง 110 กม. (NEDC)" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-black leading-tight", children: "BYD DM-i" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-muted-foreground leading-relaxed", children: isEn ? "Powered by a high-output electric motor combined with a 1.5-liter four-cylinder engine designed specifically for plug-in hybrids, plus BYD's exclusive high-safety Blade Battery." : "ขับเคลื่อนด้วยมอเตอร์ไฟฟ้ากำลังสูง ผสานเครื่องยนต์ขนาด 1.5 ลิตร 4 สูบ ที่ออกแบบมาเพื่อรถยนต์ปลั๊กอินไฮบริดโดยเฉพาะ และ BYD Blade Battery ความปลอดภัยสูง เอกสิทธิ์เฉพาะจาก BYD" })
          ] })
        ] })
      ] }),
