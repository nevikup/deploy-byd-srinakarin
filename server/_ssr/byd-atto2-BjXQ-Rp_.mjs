...
import { o as SLUG$1, u as useI18n, P as PageShell } from "./router-CZ2WxP15.mjs";
import { T as notFound } from "../_libs/tanstack__router-core.mjs";
import { a as getModel, c as calcInstallment, f as formatBaht, n as colorSurgeWhite } from "./models-2MA_lXr_.mjs";
...
const EXTERIOR_GALLERY_EN = [
  ...
  { img: exteriorTailLight, label: "Mobius Ring Tail Light", desc: "Continuous LED rear lights with a standout night-time signature" },
  { img: exteriorAlloyWheels, label: "17-inch Alloy Wheels", desc: "17-inch alloy wheels that balance style and performance" },
  { img: exteriorDigitalKey, label: "Digital Key", desc: "Unlock and start the car via smartphone with the digital key" },
  { img: exteriorVtoL, label: "Vehicle-to-Load (V2L)", desc: "V2L technology powers external devices directly from the car's battery" }
];
...
const INTERIOR_GALLERY_EN = [
  ...
  { img: interiorPassengerSeats, label: "Front Passenger Seat", desc: "Adjustable front passenger seat for comfort throughout the journey" },
  { img: interiorRearAirComfort, label: "Rear Air Vents", desc: "Rear air-conditioning vents keep every passenger comfortable" }
];
const DIMENSIONS = [
...
function BydAtto2Brochure({ model }) {
  ...
  const vehicleSchema = {
    ...
    offers: {
      ...
      seller: { "@type": "AutoDealer", name: isEn ? "BYD Jinlong Srinakarin" : "BYD จินหลง ศรีนครินทร์" }
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative w-full min-h-[88vh] flex items-end overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full px-6 sm:px-12 lg:px-20 pb-16 pt-32", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-block rounded-full border border-primary/40 px-3 py-1 text-xs text-primary mb-4 backdrop-blur-sm bg-background/20", children: isEn ? "Compact SUV EV · e-Platform 3.0 · 2026" : "Compact SUV EV · e-Platform 3.0 · 2026" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `mt-3 text-xl sm:text-2xl text-muted-foreground font-light ${isEn ? "tracking-widest" : "tracking-normal leading-snug"}`, children: isEn ? "FOR THE WAY YOU MOVE" : "พร้อมไปในทุกเส้นทางของคุณ" })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 220, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 flex flex-wrap gap-3", children: [
          { label: isEn ? "Range" : "ระยะทางวิ่ง", val: "410 km" },
          { label: "0-100 km/h", val: isEn ? "7.9 sec" : "7.9 วินาที" },
          { label: isEn ? "Max Power" : "กำลังสูงสุด", val: "130 kW" },
          { label: isEn ? "Max Torque" : "แรงบิดสูงสุด", val: "290 Nm" },
          { label: isEn ? "Battery" : "แบตเตอรี่", val: "51.13 kWh" }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 border-y border-border bg-surface/40", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-3xl p-6 sm:p-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4", children: [
          { label: "0-100 km/h", val: `${currentTrim.accel} ${isEn ? "sec" : "วินาที"}` },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative w-full bg-black overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", style: { maxHeight: "80vh", aspectRatio: "16/9" }, children: [
      ...
      !videoPlaying && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center cursor-pointer", style: { background: "rgba(0,0,0,0.38)" }, onClick: handlePlayVideo, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-white text-lg font-semibold tracking-widest uppercase", children: isEn ? "BYD ATTO 2 - Official Film" : "วิดีโอแนะนำ BYD ATTO 2" })
      ] })
    ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Reveal, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: isEn ? "A full-body design ready for every lifestyle" : "ดีไซน์รอบคันพร้อมตอบโจทย์ทุกไลฟ์สไตล์" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "border-y border-border overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: storyCompactSuvImage, imgAlt: "Compact SUV", reverse: false, title: isEn ? "FOR THE WAY YOU MOVE" : "พร้อมไปในทุกเส้นทางของคุณ", subtitle: isEn ? "Compact SUV EV" : "คอมแพ็กต์ SUV ไฟฟ้า", body: isEn ? "A compact SUV EV that blends striking design, agile handling, and everyday usability" : "คอมแพ็กต์ SUV ไฟฟ้าที่ผสานดีไซน์โดดเด่น ความคล่องตัว และการใช้งานจริงในทุกวัน" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: storyDesignConceptImage, imgAlt: "Design Concept", reverse: true, title: isEn ? "DRAGON FACE DESIGN" : "ดีไซน์ DRAGON FACE", subtitle: isEn ? "Signature Styling" : "ดีไซน์เอกลักษณ์", body: isEn ? "Flowing yet assertive exterior lines with a distinctive presence from every angle" : "เส้นสายภายนอกลื่นไหลแต่หนักแน่น สร้างบุคลิกชัดเจนจากทุกมุมมอง" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureBlock, { img: storyEPlatformImage, imgAlt: "e-Platform and Blade Battery", reverse: false, title: "e-PLATFORM 3.0 + BLADE BATTERY", subtitle: isEn ? "Core Technology" : "เทคโนโลยีหลัก", body: isEn ? "Elevating performance, safety, and efficiency in the next generation of EVs" : "ยกระดับสมรรถนะ ความปลอดภัย และประสิทธิภาพสำหรับรถ EV เจเนอเรชันใหม่" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: isEn ? "Tech Spec" : "ข้อมูลสเปก" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Performance" : "สมรรถนะ", icon: Gauge, rows: performanceRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SpecTable2, { title: isEn ? "Multimedia and Comfort" : "ระบบมัลติมีเดียและความสะดวกสบาย", icon: CircuitBoard, rows: multimediaRows, leftHeader: "Dynamic", rightHeader: "Premium", isEn }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "installment", className: "py-20 bg-surface/40 border-y border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: isEn ? "Finance" : "ไฟแนนซ์" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: isEn ? "BYD ATTO 2 Payment Plan" : "ตารางผ่อน BYD ATTO 2" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "test-drive", className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-primary text-sm font-semibold mb-2", children: isEn ? "Test Drive" : "ทดลองขับ" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl sm:text-4xl font-bold", children: isEn ? "Book a BYD ATTO 2 test drive" : "นัดทดลองขับ BYD ATTO 2" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(FAQ, { items: faqs, title: isEn ? "Frequently Asked Questions About BYD ATTO 2" : "คำถามที่พบบ่อยเกี่ยวกับ BYD ATTO 2" }),
