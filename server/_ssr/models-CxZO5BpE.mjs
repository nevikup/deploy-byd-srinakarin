...
import { I as INSTALLMENT_MODELS } from "./models-2MA_lXr_.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative min-h-[56vh] overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 sm:py-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex rounded-full bg-background/80 px-3 py-1 text-xs font-semibold tracking-[0.14em] uppercase text-primary backdrop-blur animate-fade-in", children: t("models.badge") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-4 text-4xl sm:text-6xl font-semibold tracking-normal leading-[1.05] animate-fade-in-up", children: t("models.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-5 text-base sm:text-xl text-muted-foreground max-w-2xl animate-fade-in-up", children: t("models.subtitle") })
      ] }) })
    ] }),
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: m.href, className: "group relative flex min-h-[360px] flex-col overflow-hidden rounded-3xl glass border border-border/60 hover-lift focus:outline-none focus:ring-2 focus:ring-primary/60 animate-fade-in-up", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 flex-col gap-3 p-5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] uppercase tracking-wider text-muted-foreground", children: t("models.startFrom") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-muted-foreground", children: t("models.baht") })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto flex items-center justify-between border-t border-border/60 pt-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-muted-foreground", children: t("models.viewDetail") }),
