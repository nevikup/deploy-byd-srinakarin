...
import { M as MODELS, g as getInstallmentModel, a as getModel, I as INSTALLMENT_MODELS } from "./models-hBzcyjxT.mjs";
import { c as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { c as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-k4z81Eom.mjs";
...
import "node:https";
import "node:http2";
const appCss = "/assets/styles-DePBPnfH.css";
...
const translations = {
  th: {
    ...
    "footer.companyDesc": "บีวายดี จินหลง มอเตอร์ สาขานครอินทร์ ตัวแทนจำหน่ายรถยนต์ไฟฟ้า BYD โชว์รูมและศูนย์บริการมาตรฐาน BYD",
    "footer.openingHours": "ฝ่ายขายเปิดทุกวัน  08.30 น. - 18.00 น.\nฝ่ายบริการเปิด จันทร์ - เสาร์  08.30 น. - 17.30 น.",
    ...
    "form.errorDateRequired": "กรุณาเลือกวันที่นัดหมาย",
    "form.errorDatePast": "วันที่นัดหมายต้องไม่ย้อนหลัง",
    "form.errorDateMax": "วันที่นัดหมายเลือกได้ไม่เกิน 1 เดือนจากวันนี้",
    ...
    "contact.mapAria": "แผนที่โชว์รูม BYD",
    "contact.mapPinLabel": "หมุด",
    "contact.openInGoogleMaps": "เปิดใน Google Maps",
    "contact.branchTitle": "บีวายดี จินหลง มอเตอร์ สาขา ศรีนครินทร์",
    ...
    "testDrive.heroAlt": "ทดลองขับ BYD ที่โชว์รูม BYD จินหลง ศรีนครินทร์",
    "testDrive.benefitModelsTitle": "ทดลองขับทุกรุ่น",
    "testDrive.benefitModelsDesc": "รองรับรถทุกรุ่นที่เรามี ได้แก่ BYD DOLPHIN, BYD ATTO 1, BYD ATTO 2, BYD ATTO 3, BYD SEAL, BYD SEAL 5 DM-i, BYD SEAL 6, BYD SEALION 5 DM-i, BYD SEALION 6 DM-i, BYD SEALION 7 และ BYD M6",
    "testDrive.benefitHospitalityTitle": "บริการต้อนรับ",
    "testDrive.benefitHospitalityDesc": "เครื่องดื่มและของว่างจัดเตรียมไว้",
    "testDrive.benefitTimeTitle": "เพียง 30 นาที",
    "testDrive.benefitTimeDesc": "ทดลองขับเส้นทางจริง รับคำแนะนำมืออาชีพ",
    "testDrive.benefitLocationTitle": "สถานที่",
    "testDrive.benefitLocationDesc": "มีให้บริการหลายสาขาใกล้บ้านท่าน",
    "testDrive.faq1q": "การทดลองขับมีค่าใช้จ่ายไหม?",
    "testDrive.faq1a": "ฟรี ไม่มีค่าใช้จ่าย เป็นบริการก่อนตัดสินใจซื้อ",
    "testDrive.faq2q": "ต้องเตรียมเอกสารอะไร?",
    "testDrive.faq2a": "ใบขับขี่รถยนต์และบัตรประชาชนตัวจริง",
    "testDrive.faq3q": "อายุเท่าไรจึงทดลองขับได้?",
    "testDrive.faq3a": "20 ปีขึ้นไป มีใบขับขี่ที่ยังไม่หมดอายุ",
  ...
  en: {
    ...
    "footer.companyDesc": "BYD Jinlong Motor Nakhon In branch, official BYD EV dealer with showroom and certified service center.",
    "footer.openingHours": "Sales open daily 08.30 AM - 06.00 PM.\nService open Monday - Saturday 08.30 AM - 05.30 PM.",
    ...
    "form.errorDateRequired": "Please select an appointment date.",
    "form.errorDatePast": "Appointment date cannot be in the past.",
    "form.errorDateMax": "Appointment date must be within 1 month from today.",
    ...
    "contact.mapAria": "BYD showroom map",
    "contact.mapPinLabel": "Pin",
    "contact.openInGoogleMaps": "Open in Google Maps",
    "contact.branchTitle": "BYD Jinlong Motor Srinakarin Branch",
    ...
    "testDrive.heroAlt": "BYD test drive at BYD Jinlong Srinakarin showroom",
    "testDrive.benefitModelsTitle": "Test drive every model",
    "testDrive.benefitModelsDesc": "Available for all models including BYD DOLPHIN, BYD ATTO 1, BYD ATTO 2, BYD ATTO 3, BYD SEAL, BYD SEAL 5 DM-i, BYD SEAL 6, BYD SEALION 5 DM-i, BYD SEALION 6 DM-i, BYD SEALION 7, and BYD M6",
    "testDrive.benefitHospitalityTitle": "Hospitality service",
    "testDrive.benefitHospitalityDesc": "Complimentary drinks and snacks are prepared",
    "testDrive.benefitTimeTitle": "Just 30 minutes",
    "testDrive.benefitTimeDesc": "Real-route test drive with professional guidance",
    "testDrive.benefitLocationTitle": "Location",
    "testDrive.benefitLocationDesc": "Available at multiple branches near you",
    "testDrive.faq1q": "Is there any cost for a test drive?",
    "testDrive.faq1a": "No. It is completely free before making your purchase decision.",
    "testDrive.faq2q": "What documents should I bring?",
    "testDrive.faq2a": "Your valid driving license and national ID card.",
    "testDrive.faq3q": "What is the minimum age for a test drive?",
    "testDrive.faq3a": "You must be at least 20 years old with a valid driving license.",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-10 md:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm leading-relaxed", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "whitespace-pre-line", children: t("footer.openingHours") })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
const $$splitComponentImporter$n = () => import("./test-drive-byd-CsdacVJU.mjs");
...
const $$splitComponentImporter$m = () => import("./models-3VRzRq39.mjs");
...
const $$splitComponentImporter$l = () => import("./contact-DI14GUDR.mjs");
...
const $$splitComponentImporter$k = () => import("./byd-sealion7-DAL7AYc4.mjs");
...
const $$splitComponentImporter$j = () => import("./byd-sealion6dmi-DyC8YvPl.mjs");
...
const $$splitComponentImporter$i = () => import("./byd-sealion5dmi-DYyV9iUx.mjs");
...
const $$splitComponentImporter$g = () => import("./byd-seal6-Ysi-Yvl5.mjs");
...
const $$splitComponentImporter$f = () => import("./byd-seal5dmi-C0HFRqKU.mjs");
...
const $$splitComponentImporter$e = () => import("./byd-seal-A-ZKViJr.mjs");
...
const $$splitComponentImporter$d = () => import("./byd-promotion-C3mELexS.mjs");
...
const SLUG$4 = "byd-m6";
const $$splitComponentImporter$c = () => import("./byd-m6-BpvOZjMy.mjs");
...
const $$splitComponentImporter$b = () => import("./byd-installment-DB8gY9S9.mjs");
...
const $$splitComponentImporter$a = () => import("./byd-dolphin-COs6yz-h.mjs");
...
const $$splitComponentImporter$9 = () => import("./byd-atto3-DNSnL5Pa.mjs");
...
const $$splitComponentImporter$8 = () => import("./byd-atto2-BAjf8C_m.mjs");
...
const $$splitComponentImporter$7 = () => import("./byd-atto1-DfOj98VJ.mjs");
...
const $$splitComponentImporter$6 = () => import("../_slug-Ba39mCJm.mjs");
...
const $$splitComponentImporter$5 = () => import("./index-BMPt6g9M.mjs");
reactExports.lazy(() => import("./InstallmentCalculator-DSngE03R.mjs").then((module) => ({
...
const $$splitComponentImporter$4 = () => import("./index-DxcRvSML.mjs");
...
const $$splitComponentImporter$2 = () => import("../_slug-DaXt4iQ1.mjs");
