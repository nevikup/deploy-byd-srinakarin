...
import { s as Route$4, u as useI18n, A as ARTICLES, P as PageShell, t as heroImg, H as HOME_SLIDES_ENDPOINT, v as extractSlideImageUrls, w as extractLargestSrcsetUrl, x as normalizeImageUrl } from "./router-B11iHl0p.mjs";
...
const ModelsScroller = reactExports.lazy(() => import("./ModelsScroller-CBNKctLW.mjs").then((module) => ({
...
const FAQ = reactExports.lazy(() => import("./FAQ-D-AN22HF.mjs").then((module) => ({
  default: module.FAQ
})));
