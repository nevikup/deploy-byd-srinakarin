...
import { s as Route$5, u as useI18n, A as ARTICLES, P as PageShell, t as heroImg, H as HOME_SLIDES_ENDPOINT, v as extractSlideImageUrls, w as extractLargestSrcsetUrl, x as normalizeImageUrl } from "./router-CxN_7A6C.mjs";
...
const ModelsScroller = reactExports.lazy(() => import("./ModelsScroller-D-FqKteR.mjs").then((module) => ({
...
const FAQ = reactExports.lazy(() => import("./FAQ-B08g9k-k.mjs").then((module) => ({
  default: module.FAQ
})));
