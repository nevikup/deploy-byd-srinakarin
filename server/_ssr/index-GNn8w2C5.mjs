...
import { s as Route$5, u as useI18n, A as ARTICLES, P as PageShell, t as heroImg, H as HOME_SLIDES_ENDPOINT, v as extractSlideImageUrls, w as extractLargestSrcsetUrl, x as normalizeImageUrl } from "./router-DAtOa4Us.mjs";
...
const ModelsScroller = reactExports.lazy(() => import("./ModelsScroller-sXgqHvcu.mjs").then((module) => ({
...
const FAQ = reactExports.lazy(() => import("./FAQ-IQt0fN4_.mjs").then((module) => ({
  default: module.FAQ
})));
